(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('rules-engine/src/Rules')) :
  typeof define === 'function' && define.amd ? define(['rules-engine/src/Rules'], factory) :
  (global = global || self, global.RulesEditor = factory(global.Rules));
}(this, (function (Rules) {
  ...
  var HighlightRules$2 = /*#__PURE__*/function (_TextHighlightRules) {
    ...
    function HighlightRules(language) {
      ...
      _this.keywords = {};
      _this.rules = new Rules.Rules(language, mode);
  ...
  */
  ...
  var _default$2 = /*#__PURE__*/function (_TextMode) {
    ...
    function _default(editor, watch) {
      ...
      _this.rules = new Rules.Rules(_this.editor.session.language || "en", _this.$id);
  ...
  var _default = /*#__PURE__*/function (_TextMode) {
    ...
    function _default(editor, onlyHighlight) {
      ...
      _this.rules = new Rules.Rules(_this.editor.session.language || "en", _this.$id); // If static highlighter, do not watch for changes
