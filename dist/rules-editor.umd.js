(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('rules-engine')) :
  typeof define === 'function' && define.amd ? define(['rules-engine'], factory) :
  (global = global || self, global.RulesEditor = factory(global.RulesEngine));
}(this, (function (rulesEngine) {
  ...
  var HighlightRules$2 = /*#__PURE__*/function (_TextHighlightRules) {
    ...
    function HighlightRules(language) {
      ...
      _this.keywords = {};
      _this.rules = new rulesEngine.Rules(language, mode);
  ...
  */
  ...
  var _default$2 = /*#__PURE__*/function (_TextMode) {
    ...
    function _default(editor, watch) {
      ...
      _this.rules = new rulesEngine.Rules(_this.editor.session.language || "en", _this.$id);
  ...
  var _default = /*#__PURE__*/function (_TextMode) {
    ...
    function _default(editor, onlyHighlight) {
      ...
      _this.rules = new rulesEngine.Rules(_this.editor.session.language || "en", _this.$id); // If static highlighter, do not watch for changes
